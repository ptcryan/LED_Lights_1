...
void Fire2012(void);
void lightenings(void);
void EHCSparkle(void);
void addEHCGlitter(fract8 chanceOfGlitter);
...
SimplePatternList gPatterns = { rainbow, rainbowWithGlitter, confetti, sinelon, juggle, bpm, lightenings, Sparkle, EHCSparkle };
...
//  leds[Pixel] = CRGB(random(255),random(255),random(255));
  leds[Pixel] = CHSV(random(255),random(255),255);
}
